...
1. Single Responsibility Principle (SRP): Each class should have a single responsibility (e.g., order logic, payment processing, notification, storage should be separate)
2. Open/Closed Principle (OCP): You should be able to add: New payment methods, New notification types, Without modifying existing classes
...
4. Interface Segregation Principle (ISP): Avoid large interfaces, Design small, role-specific interfaces (e.g., donâ€™t force all classes to implement unused methods)
